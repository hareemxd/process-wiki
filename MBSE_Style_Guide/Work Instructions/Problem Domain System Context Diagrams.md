...
This Model Based Systems Engineering (MBSE) Work Instruction demonstrates the procedures to create structural diagrams in the Problem Domain. Adherence to this document ensures that new SysML diagrams conform to DRS Naval Electronics process and quality standards.
...
[Figure 4](#fig-pdsc-bdd) provides an example of a properly styled PDSC BDD.
...
<ac:image ac:align="center">
  <ri:attachment ri:filename="bigdia1.png"/>
</ac:image>
...
<ac:image ac:align="center">
  <ri:attachment ri:filename="bigdia2.png"/>
</ac:image>
